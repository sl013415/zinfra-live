...
module "static_site" {
  ...
  name                = "zeneppemlswas01"
  resource_group_name = var.resource_group_name
  location            = var.location
  custom_domain_verification_id = "agreeable-beach-08611cf0f.5.azurestaticapps.net"
  host_name = "stg-verification.zelis.com"
  record_type = "CNAME"
...
module "app-kv" {
 ...
 module "Custom_DNS_2"{
     ...
     zone_name         = var.zone_name
     host_name = "stg-entport.zelis.com"
     record_type = "CNAME"
     custom_domain_verification_id = "zeneppfas01.azurewebsites.net"
