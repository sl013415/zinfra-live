...
module "Custom_DNS_Bench_Broker" {
  source = "git::https://dev.azure.com/Zelis-CloudPractice/Azure-CloudAutomation/_git/zelis_TF_PAAS_Modules//Modules//aws_route53_zone_record"
  providers = {
    aws                 = aws,
    azurerm             = azurerm,
  ...
  zone_name                            = var.zone_name
  host_name                            = "rbp-benchmark-broker-prod.zelis.com"
  record_type                          = var.record_type
  custom_domain_verification_id        = "zcmrbpbbaadr01.azurewebsites.net"
  application_name                     = "zcmrbpbbaadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "Custom_DNS_Bench_ERS" {
  ...
  custom_domain_verification_id        = "zcmrbpersaadr01.azurewebsites.net"
  application_name                     = "zcmrbpersaadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "Custom_DNS_Bench_FairHealth" {
  ...
  custom_domain_verification_id        = "zcmrbpfhaadr01.azurewebsites.net"
  application_name                     = "zcmrbpfhaadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "Custom_DNS_Bench_Lookup" {
  ...
  custom_domain_verification_id        = "zcmrbplkpwadr01.azurewebsites.net"
  application_name                     = "zcmrbplkpwadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "Custom_DNS_Bench_Medicare" {
  ...
  custom_domain_verification_id        = "zcmrbpmdraadr01.azurewebsites.net"
  application_name                     = "zcmrbpmdraadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "Custom_DNS_Bench_Milliman" {
  ...
  custom_domain_verification_id        = "zcmrbpmlnaadr01.azurewebsites.net"
  application_name                     = "zcmrbpmlnaadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "Custom_DNS_Bench_Precert_Portal" {
  ...
  custom_domain_verification_id        = "zcmrbppctprtwadr01.azurewebsites.net"
  application_name                     = "zcmrbppctprtwadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "Custom_DNS_Bench_Truven" {
  ...
  custom_domain_verification_id        = "zcmrbptrvaadr01.azurewebsites.net"
  application_name                     = "zcmrbptrvaadr01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
