...
locals {
fn_app_names = {
"zenpmtfesffap01" = "zenpmtfesfstrp01"
"zenpmtbesffap01" = "zenpmtbesfstrp01"
}
 ...
 module "win-fun-app" {
  ...
  env = var.env
   ...
   module "CustomDNS_Frontend"{
     ...
     record_type = var.record_type
     application_name    = "zenpmtfesffap01"
     custom_domain_verification_id = "zenpmtfesffap01.azurewebsites.net"
     appservice_plan_name                =  var.appservice_plan_name
     appservice_plan_resource_group_name =  var.appservice_plan_resource_group_name
     resource_group_name = module.app-rg.name
     shared_key_vault_name = var.shared_key_vault_name
   ...
   module "CustomDNS_Backend"{
     ...
     record_type = var.record_type
     application_name    = "zenpmtbesffap01"
     custom_domain_verification_id = "zenpmtbesffap01.azurewebsites.net"
     appservice_plan_name                =  var.appservice_plan_name
     appservice_plan_resource_group_name =  var.appservice_plan_resource_group_name
