...
variable "win_web_app_name" {
  type        = string
  description = "Windows web app name"
}
variable "lin_web_app_name" {
  type        = string
  description = "Linux web app name"
}
variable "win_fun_app_name" {
  type        = string
...
# # ---------------------------
 ...
 variable "appservice_plan_resource_group_name" {
  ...
  variable "lin_asp_name" {
   description = "(Required) App Service Plan Name for the App Service."
   type        = string
 }
 variable "lin_asp_rg_name" {
   description = "(Required) App Service Plan Resource Group Name."
   type        = string
 }
...
# # ---------------------------------------------
 ...
 variable "subnet_id" {
  ...
  variable "lin_subnet_id" {
   type        = string
   description = "(Required) Linux Subnet ID for VNET Integration."
 }
   variable "env" {
   type        = string
