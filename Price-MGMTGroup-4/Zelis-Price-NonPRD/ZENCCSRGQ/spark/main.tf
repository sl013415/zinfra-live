...
module "CustomDNS2" {
  ...
  #host_name = "zccsspkfaq01.zelis.com"
  zone_name                            = var.zone_name
  record_type                          = var.record_type
  custom_domain_verification_id        = "zccsspkfaq01.azurewebsites.net"
  application_name                     = "zccsspkfaq01"
  resource_group_name                  = var.resource_group_name
  appservice_plan_name                 = var.appservice_plan_name
  appservice_plan_resource_group_name  = var.appservice_plan_resource_group_name
  shared_key_vault_name                = var.shared_key_vault_name
...
module "CustomDNS_FA" {
  ...
  host_name = "sparkecrapiqa.zelis.com"
  zone_name                            = var.zone_name
  record_type                          = var.record_type
  custom_domain_verification_id        = "zccsspkfaq01.azurewebsites.net"
  application_name                     = "zccsspkfaq01"
