...
private_endpoint_name = "zenadppedr01"
subnet_name = var.subnet_name
location            = var.location
resource_group_name = var.resource_group_name
private_service_connection_name = "zenadppscdr01"
...
module "win_fn_app" {
 ...
 module "Custom_DNS"{
  ...
  module "Custom_DNS2"{
     ...
     custom_domain_verification_id ="zenapimdpfadr01.azurewebsites.net"
     application_name    = var.application_name
     resource_group_name = var.resource_group_name
     appservice_plan_name                =  var.appservice_plan_name
     appservice_plan_resource_group_name =  var.appservice_plan_resource_group_name
