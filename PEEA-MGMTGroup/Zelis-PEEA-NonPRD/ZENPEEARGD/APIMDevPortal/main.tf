...
private_endpoint_name = "zenadpped01"
subnet_name = var.subnet_name
location            = var.location
resource_group_name = var.resource_group_name
private_service_connection_name = "zenadppscd01"
...
module "win_fn_app" {
 ...
 module "Custom_DNS_2"{
     ...
     zone_name         = var.zone_name
     host_name = "dev-devportalsignupapi.zelis.com"
     record_type = "CNAME"
     custom_domain_verification_id = "zenapimdpfad01.azurewebsites.net"
