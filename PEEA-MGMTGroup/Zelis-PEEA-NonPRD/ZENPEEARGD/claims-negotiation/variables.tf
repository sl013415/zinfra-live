...
variable "storage_account_id" {
  description = "(Required) storage_account_id for function App."
  type        = string
  default     = ""
}
...
variable "lz_DR_subnet_id" {
  type        = string
  description = "(Required) DR Subnet ID for VNET Integration."
}
variable "zone_name" {
  type        = string
...
variable "host_name" {
  description = "(optional) Custom Host name which will be set as tag per policy."
  type        = string
  default     = null
}
