...
private_endpoint_name = "zenadppeq01"
subnet_name = var.subnet_name
location            = var.location
resource_group_name = var.resource_group_name
private_service_connection_name = "zenadppscq01"
...
module "win_fn_app" {
 ...
 module "Custom_DNS_2"{
     ...
     zone_name         = var.zone_name
     host_name = "qa-devportalsignupapi.zelis.com"
     record_type = "CNAME"
     custom_domain_verification_id = "zenapimdpfaq01.azurewebsites.net"
     application_name    = "zenapimdpfaq01"
     resource_group_name = var.resource_group_name
     appservice_plan_name                =  var.appservice_plan_name
     appservice_plan_resource_group_name =  var.appservice_plan_resource_group_name
     shared_key_vault_name = var.shared_key_vault_name
